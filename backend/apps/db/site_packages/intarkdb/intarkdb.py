...
def connect(database = ".", host = None, port = None, user = None, password = None, connect_timeout = None, socket_timeout = None):

    conn = Connection(database=database, host=host, port=port, user=user, password=password, connect_timeout=connect_timeout, socket_timeout=socket_timeout)
