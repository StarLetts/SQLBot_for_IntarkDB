    ...
    def execute(self, operation, parameters=None):
        ...
        with Cursor.CURSOR_LOCK:
            ...
            if(parameters != None):
                ...
                if ret != SQL_SUCCESS:
                    print("intarkdb prepare fail, operation: %s" % operation)
                ...
                for col in range(len(parameters)):
                    ...
                    if(ret == SQL_ERROR):
                        print("intarkdb bind value fail, operation: %s" % operation)
                        msg = self.__sql.intarkdb_prepare_errmsg(self.__statement, self._network)
                        raise ProgrammingError(ret, msg)
                ...
                if ret != SQL_SUCCESS:
                    print("intarkdb execute prepared fail, operation: %s" % operation)
                    msg = self.__sql.intarkdb_prepare_errmsg(self.__statement, self._network)
                    raise ProgrammingError(ret, msg)
            ...
            # 查询失败
                ...
                print("intarkdb query fail, operation: %s" % operation)
        ...
        with Cursor.CURSOR_LOCK:
            ...
            for row in range(len(seq_of_parameters)):
                for col in range(len(seq_of_parameters[row])):
                    ...
                    if(ret == SQL_ERROR):
                        print("intarkdb client bind value fail, operation: %s" % operation)
                        msg = self.__sql.intarkdb_prepare_errmsg(self.__statement, self._network)
                        raise ProgrammingError(ret, msg)
                ...
                if ret != SQL_SUCCESS:
                    # 获取错误的sql
                    if self._network == False:
                        err_operation = self.__sql.intarkdb_expanded_sql(self.__statement)
                        print("intarkdb execute prepared fail, operation: %s" % err_operation)
                    else:
                        print("intarkdb client execute prepared fail, row: %d" % row)
            ...
            # 查询失败
                ...
                print("intarkdb query(many) fail, operation: %s" % operation)
                msg = self.__sql.intarkdb_result_msg(self.__resultset, self._network)
                raise ProgrammingError(ret, msg)
